...
class Entite extends Common
{
    ...
    protected $ID_Entite; // PRI
    const primary_key = 'ID_Entite'; // PRI
    protected $ID_TypeEntite;
    ...
    protected $Parent_TypeEntite;

    // **********************
    // Childs array of object for this class (Foreign Keys)
    // **********************
    
    protected $Exercice_Exercice;
    protected $Exercice_Entite;
    protected $Piece_Entite;
